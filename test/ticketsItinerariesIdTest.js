...
`;
  ...
  describe("/GET /tickets/itineraries/1", () => {
    before(done => {
      const sql = `
    ...
    it("it should get a ticket where the ID is 1", done => {
      chai
        .request(server)
        .get("/online/tickets/itineraries/1")
        .end((error, result) => {
  ...
  describe("/GET /tickets/itineraries/0", () => {
    before(done => {
      const sql = `
        INSERT INTO airport (id, name, street, city, state, country, postal_code) VALUES(1, "PDX", "5th street", "Portland", "Oregon", "US", "98661");
        INSERT INTO airport (id, name, street, city, state, country, postal_code) VALUES(2, "Seatac", "3rd Ave.", "Seattle", "Oregon", "US", "98661");
    ...
    it("it should throw a 400 error where the ID is 0", done => {
      chai
        .request(server)
        .get("/online/tickets/itineraries/0")
        .end((error, result) => {
  ...
  describe("/GET /tickets/itineraries/null", () => {
    before(done => {
      const sql = `
        INSERT INTO airport (id, name, street, city, state, country, postal_code) VALUES(1, "PDX", "5th street", "Portland", "Oregon", "US", "98661");
        INSERT INTO airport (id, name, street, city, state, country, postal_code) VALUES(2, "Seatac", "3rd Ave.", "Seattle", "Oregon", "US", "98661");
    ...
    it("it should throw a 400 error where the ID is null", done => {
      chai
        .request(server)
        .get("/online/tickets/itineraries/null")
        .end((error, result) => {
          result.should.have.status(400);
          result.body.should.be.a("object");
          result.body.should.have.property("status");
